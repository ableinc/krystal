...
_snowboydetect = get_snowboy_detect_file()
...
class SnowboyDetect(object):
    ...
    def __setattr__(self, name, value):
        return _swig_setattr(self, SnowboyDetect, name, value)

    def __getattr__(self, name):
        return _swig_getattr(self, SnowboyDetect, name)
